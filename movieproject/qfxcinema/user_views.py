        ...
        if user_created_form.is_valid() and profile_form.is_valid():
            ...
            try:
                ...
                return render(request, self.template_name, {
                    ...
                    'user_form': user_created_form, 'profile_form': profile_form, 'error': 'retry'})
...
class UserUpdateView(View):
    ...
    def get(self, request):
        ...
        context = {
            ...
            'user_form': user_form, 'profile_form': profile_form, 'Update': 'Update'}
        return render(request, self.template_name, context)
    ...
    def post(self, request):
        ...
        if change_form.is_valid():
            ...
            try:
                ...
                created_user.save()
                return render(request, 'user/detail.html', {'message': 'Your Password Has been Changed Successfully'})

            except:
                return render(request, 'user/change_password.html', {

                    'form': 'change_form', 'message': 'Password Change is unsuccessful'
